...
const CHECKS = [
  ...
  {
    key:    'ms2_clientes',
    label:  'MS2 — Pedidos: GET /ms2/clientes  [health check]',
  ...
  {
    key:    'ms3_resenas',
    label:  'MS3 — Reseñas: GET /resenas  [health check — raíz, no /ms3]',
    fetch:  () => resenasService.getResenas(),
    badge:  'MS3',
  },
  {
    key:    'ms3_stats',
    label:  'MS3 — Reseñas: GET /resenas/stats/libro/1',
    fetch:  () => resenasService.getStatsLibro(1),
    badge:  'MS3',
  },
  {
